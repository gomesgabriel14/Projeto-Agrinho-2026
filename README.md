...
Site desenvolvido envolvendo o tema Eco Abelha
Tema agrinho 2026: Agro forte, futuro sustentável: equilíbrio entre produção e meio ambiente
Autor: Gabriel Gomes da Silva
Escola: Colégio Estadual Adélia Bianco Seguro
Município: Mato Rico
...
* Interatividade dinâmica utilizando JavaScript estruturado.
* Navegação fluida entre telas/fases sem interrupções técnicas.
* Tecnologias e Organização do Código
## O projeto foi desenvolvido estritamente de acordo com os critérios técnicos exigidos pelo regulamento do concurso:
* **HTML5:** Utilizado para a marcação estrutural e semântica da página.
* **CSS3:** Responsável por toda a estilização, paleta de cores harmoniosa e layout.
* **JavaScript (Vanilla JS):** Responsável pela lógica de programação, eventos e interações.
  ##Uso de Inteligência Artificial e Créditos de Imagem
  Ferramenta Utilizada:** Google Gemini / Imagen
  Prompts Utilizados para Geração:**

 1. Identificador: IMG_CIENCIA_ELETROSTATICA_POLEN
  Seção de Destino: Mecanismos Técnicos e Científicos da Polinização.  Resolução Nativa: 7680 × 5120 pixels (8K DCI, proporção de aspecto 3:2).  Prompt 1. Profissional para IA:  A 3D scientific rendering and microscopic cross-section illustrating electrostatic pollination. An extreme close-up of a bumblebee's branched hair structure accumulating a glowing positive static electric charge (+). Microscopic grains of pollen, carrying a negative charge (-), are seen magnetically flying through the air, attracted to the bee's coat. Scientific diagram style without text, soft studio lighting, deep amber and dark charcoal background, high tech biophysics visualization, octanerender quality, raytracing, ultra-fine textures, 8k resolution.

2. Identificador: IMG_DASHBOARD_SEGURANCA_ALIMENTAR
Seção de Destino: Impacto na Segurança Alimentar Mundial.

Resolução Nativa: 7680 × 4320 pixels (8K UHD, proporção de aspecto 16:9).

Prompt Profissional para IA:
 *[Professional editorial food photography, a rustic wooden harvest table overflowing with a bountiful, colorful spread of premium crops completely dependent on bee pollination: ripe avocados, dark roasted coffee beans, shiny red apples, juicy oranges, berries, and large red tomatoes. Elegant, clean composition with soft side-window lighting, cinematic atmosphere, crisp textures of fruit skin and dew drops, editorial style, shot on 50mm lens f/4, highly detailed culinary display, 8k resolution, neutral background.]*
     Mel flora
...
├── css/
│   └── style.css       # Estilização e design visual (sem CSS inline)
├── js/
│   └── script.js       # Lógica e interatividade em JavaScript puro
└── assets/
    └── imagens/        # Imagens geradas via Google Gemini
